  ...
  <TABLE class='table table-hover'>
    ...
    %>
      <TR>
        ...
        <TD><a href="/contents/list_by_cateno.do?cateno=<%=cateVO.getCateno() %>&now_page=1"><%=cateVO.getName() %></a></TD>
        ...
        <TD>
          ...
          <%
          if (cateVO.getVisible().equals("Y")) {
          %>
            <A href="./update_visible_n.do?cateno=<%=cateVO.getCateno() %>"><IMG src="/cate/images/show.png" class="icon"></A>
          <%  
          } else { // N
          %>
            <A href="./update_visible_y.do?cateno=<%=cateVO.getCateno() %>"><IMG src="/cate/images/hide.png" class="icon"></A>
          <%  
          }
          %>
