    ...
    <tbody>
      <c:forEach var="contentscoVO" items="${list}">
        ...
        <c:set var="thumb1" value="${contentscoVO.thumb1 }" />
         ...
         <tr style="height: 112px;" onclick="location.href='./read.do?contentscono=${contentscono }&word=${param.word }'" class='hover'>
          <td style='vertical-align: middle; text-align: center; '>
            <c:choose>
              ...
              <c:otherwise> <!-- 이미지가 없는 경우 기본 이미지 출력: /static/contentsco/images/none1.png -->
                <IMG src="/contentsco/images/none.jpg" style="width: 120px; height: 90px;">
              </c:otherwise>
            </c:choose>
          </td>  
