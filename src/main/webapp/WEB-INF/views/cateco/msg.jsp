...
<DIV class='message'>
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      %>
        <LI class='li_none'><span class="span_fail">카테고리 등록에 실패했습니다.</span></LI>
      <%  
      } else if (code.equals("update_fail")) {
      %>
        <LI class='li_none'><span class="span_fail">카테고리 수정에 실패했습니다.</span></LI>
      <%  
      } else if (code.equals("delete_fail")) {
      %>
        <LI class='li_none'><span class="span_fail">카테고리 삭제에 실패했습니다.</span></LI>
      <%  
      }
      %>
      ...
      <LI class='li_none'>
        ...
        %>
          <button onclick="location.href='./create.do'" class="btn btn-info">새로운 카테고리 등록</button>
        <%
        }
        %>
