...
SELECT cosmeno, brand, cosmename, rdate, adminno, cosme_cateno, cosme_file, cosme_file_saved, cosme_file_preview, cosme_file_size, cosme_youtube FROM cosme ORDER BY cosmeno ASC;
...
/* 전체 수정 */
UPDATE cosme
SET brand='솔데스크', cosmename='화장품', rdate=sysdate, adminno=1, cosme_cateno=2, cosme_file='2', cosme_file_saved='3', cosme_file_preview='4', cosme_file_size=20, cosme_youtube='youtube'
WHERE cosmeno=2
